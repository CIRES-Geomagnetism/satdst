...
df = pd.read_csv('./SatDst/cloud_test.csv')
#print(df.head())
...
def generate_test_samples(x = X_test, input_seq_len = input_seq_len, output_seq_len = output_seq_len):
...
test_x = generate_test_samples()
print(test_x.shape)

# num of input signals
input_dim = X_test.shape[1]
# num of output signals. Currently it is 1D
output_dim = 1
...
# Re-normalize predicted Dst
predicted_dst =   final_preds_expand * y_std + y_mean
print(predicted_dst[0])
